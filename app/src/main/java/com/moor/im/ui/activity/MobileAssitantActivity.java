...
public class MobileAssitantActivity extends FragmentActivity implements
    ...
    private Fragment fragment_mycall;
    private Fragment fragment_allcall;
    ...
    private void initDatas() {
        fragment_mycall = new MyCallFragment();
        mTabsFragment.add(fragment_mycall);

        fragment_allcall = new AllCallFragment();
        mTabsFragment.add(fragment_allcall);
