 ...
 */
public class DiscussionAddMemberActivity extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.group_add_member_btn_select_members:
                //选择成员
                Intent memberSelectIntent = new Intent(DiscussionAddMemberActivity.this, MembersSelectActivity.class);
            ...
            case R.id.group_add_member_btn_save:
                ...
                HttpManager.addDiscussionMember(sp.getString("connecTionId", ""), sessionId, members, new AddDiscussionMemberResponseHandler());
...
//			System.out.println("选择成员返回结果");
            ...
            adapter = new GVContactAdapter(DiscussionAddMemberActivity.this, membersTempList);
            group_add_member_gv.setAdapter(adapter);
        }
    ...
    class AddDiscussionMemberResponseHandler extends TextHttpResponseHandler {
        @Override
        public void onFailure(int statusCode, Header[] headers,
                              String responseString, Throwable throwable) {
            Toast.makeText(DiscussionAddMemberActivity.this, "请检查您的网络问题！！！", Toast.LENGTH_SHORT).show();
        ...
        public void onSuccess(int statusCode, Header[] headers,
            ...
            group_add_member_btn_save.setVisibility(View.VISIBLE);
            pb.setVisibility(View.GONE);
            LogUtil.d("DiscussionAddAdminActivity", "添加成员返回数据:" + responseString);
            if ("true".equals(succeed)) {

                DiscussionActivityUtil.getInstance().exit();
                Intent intent = new Intent(DiscussionAddMemberActivity.this, DiscussionActivity.class);
